...
4. Após confirmação do usuário, adicione os arquivos apropriados:
   - `git add .` para todos
5. Crie o commit com a mensagem (fornecida ou aprovada pelo usuário)
6. Mostre o resultado do commit
7. Pergunte se o usuário quer fazer push para o remoto
8. Pergunte se quer fazer deploy via ftp
