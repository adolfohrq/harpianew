    ...
    const handleScroll = () => {
      if (parallaxRef.current) {
        ...
        if (scrollPosition <= window.innerHeight) {
          // Move the video at 50% of the scroll speed to create depth
          // Maintain a scale > 1 to prevent edges from showing during translation
    ...
    <div className="w-full">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          >
            <source src="https://videos.pexels.com/video-files/5355988/5355988-uhd_2560_1440_25fps.mp4" type="video/mp4" />
