...
export const Services: React.FC = () => {
  const getIcon = (id: string) => {
    switch (id) {
      case 'foto':
        return <Camera size={32} strokeWidth={1} />;
      case 'branding':
        return <Box size={32} strokeWidth={1} />;
      case 'content':
        return <PenTool size={32} strokeWidth={1} />;
      case 'marketing':
        return <Monitor size={32} strokeWidth={1} />;
      default:
        return <Camera size={32} strokeWidth={1} />;
    }
  };
      ...
      <div className="max-w-7xl mx-auto px-6 mb-24">
        <Reveal>
          <h1 className="font-serif text-5xl md:text-7xl mb-6">
            NOSSOS <span className="italic text-gray-500">SERVIÇOS</span>
          </h1>
