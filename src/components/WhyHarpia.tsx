      ...
      <div className="max-w-7xl mx-auto px-6">
        <Reveal>
          <div className="text-center mb-20">
            ...
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl mb-6 text-harpia-black">
              POR QUE <span className="italic text-gray-400">HARPIA?</span>
            </h2>
            <p className="font-sans text-lg md:text-xl text-gray-600 max-w-2xl mx-auto font-light">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {DIFFERENTIALS.map((diff, index) => (
            <Reveal key={diff.title} delay={index * 100}>
              <div className="group relative p-8 bg-gray-50 border border-gray-100 hover:border-gray-300 transition-all duration-500">
                {/* Icon */}
                ...
                {/* Title */}
                <h3 className="font-serif text-2xl text-harpia-black mb-4 leading-tight">
                  {diff.title}
                </h3>
